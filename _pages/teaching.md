...
<div class="card mt-3">
  <div class="p-3">
    ...
    <ul class="card-text font-weight-light list-group list-group-flush">
      <li class="list-group-item"> Invited four-day lecture series (12 hours) on empirical theory at the School of Statistics and Data Science at Nakai University (CN). </li>
